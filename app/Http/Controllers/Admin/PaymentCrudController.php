...
class PaymentCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('status');
        CRUD::column('payment_system_info');
        CRUD::column('payment_system_id');
        CRUD::column('payment_type');
        CRUD::column('payment_id');
        CRUD::column('payment_key');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('status');
        CRUD::field('payment_system_info');
        CRUD::field('payment_system_id');
        CRUD::field('payment_type');
        CRUD::field('payment_id');
        CRUD::field('payment_key');
