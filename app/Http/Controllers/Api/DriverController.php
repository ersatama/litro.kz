...
class DriverController extends Controller
{
    ...
    {
        return response([
            Contract::COUNT =>  $this->driverService->driverRepository->count([]),
            Contract::DATA  =>  new DriverCollection($this->driverService->driverRepository->get($skip,$take))
        ],200);
    }
    ...
    public function getByOrderCardId($orderCardId): Response|Application|ResponseFactory
    {
        return response([
            ...
            Contract::DATA  =>  new DriverCollection($this->driverService->driverRepository->getByOrderCardId($orderCardId))
        ],200);
    }
