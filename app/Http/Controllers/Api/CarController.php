...
class CarController extends Controller
{
    ...
    {
        return response([
            Contract::COUNT =>  $this->carService->carRepository->count([]),
            Contract::DATA  =>  new CarCollection($this->carService->carRepository->get($skip,$take))
        ],200);
    }
    ...
    {
        return response([
            Contract::COUNT =>  $this->carService->carRepository->count([Contract::ORDER_CARD_ID => $orderCardId]),
            Contract::DATA  =>  new CarCollection($this->carService->carRepository->getByOrderCardId($orderCardId))
        ],200);
    }
