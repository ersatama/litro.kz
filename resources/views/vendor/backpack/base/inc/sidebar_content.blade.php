...
<li class="nav-item"><a class="nav-link" href="{{ backpack_url('dashboard') }}"><i class="nav-icon la las la-chart-bar"></i> Статистика</a></li>

@if(backpack_user()->{\App\Domain\Contracts\Contract::ROLE_ID} === 4)
...
@elseif (in_array(backpack_user()->{\App\Domain\Contracts\Contract::ROLE_ID}, [2,3]))

    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('role') }}"><i class="nav-icon las la-user-circle"></i> Роли</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('user') }}"><i class="nav-icon las la-user"></i> Пользователи</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('order-service') }}"><i class="nav-icon lab la-cc-mastercard"></i> {{ __(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::ORDER_SERVICE) }}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('order-card') }}"><i class="nav-icon la lab la-cc-mastercard"></i> {{ __(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::ORDER_CARD) }}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('gift') }}"><i class="nav-icon la lab la-cc-mastercard"></i> {{ __(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::GIFT) }}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('car') }}"><i class="nav-icon las la-car-side"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::CARS)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('driver') }}"><i class="nav-icon las la-id-card-alt"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::DRIVERS)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('card') }}"><i class="nav-icon las la-credit-card"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::CARDS)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('card-category') }}"><i class="nav-icon las la-credit-card"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::CATEGORY)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('card-range') }}"><i class="nav-icon las la-credit-card"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::CARD_RANGE)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('service') }}"><i class="nav-icon las la-people-carry"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::SERVICES)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('service-type') }}"><i class="nav-icon las la-people-carry"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::SERVICE_TYPE)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('order-service-service') }}"><i class="nav-icon lab la-cc-mastercard"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::ORDER_SERVICE_SERVICE)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('partner') }}"><i class="nav-icon las la-handshake"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::PARTNERS)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('news-category') }}"><i class="nav-icon la la-question"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::NEWS_CATEGORY)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('news') }}"><i class="nav-icon la la-question"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::NEWS)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('car-model') }}"><i class="nav-icon las la-car-alt"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::CAR_MODEL)}}</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ backpack_url('car-brand') }}"><i class="nav-icon las la-car-alt"></i> {{__(\App\Domain\Contracts\Contract::CONTRACT. '.' . \App\Domain\Contracts\Contract::CAR_BRAND)}}</a></li>
@endif
